...
export default function CheckoutPage() {
  ...
  const { agentStatus, recommendation, recovery, AGENTS, WAVE_1, WAVE_2, WAVE_3 } = useCheckoutWS(sessionId)
      ...
      {phase === 'analysing' && (
        <div>
          <div style={{ ...cardStyle, marginBottom: 16 }}>
            ...
            <AgentProgressBar agentStatus={agentStatus} wave1={WAVE_1} wave2={WAVE_2} wave3={WAVE_3} />
          </div>
